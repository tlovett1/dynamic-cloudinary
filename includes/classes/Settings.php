...
class Settings {
	...
	public function cloud_name_callback() {
		...
		<label for="dc_cloud_name">
			...
			<p class="description"><?php echo wp_kses_post( __( 'This can be found in your <a href="https://cloudinary.com/">Cloudinary</a> dashboard homepage.', 'dynamic-cloudinary' ) ); ?></p>
		</label>
		<?php
	}
	...
	public function auto_mapping_folder_callback() {
		...
		<label for="dc_auto_mapping_folder">
			...
			<p class="description"><?php echo wp_kses_post( __( 'This can be found in your <a href="https://cloudinary.com/">Cloudinary</a> dashboard settings upload section.', 'dynamic-cloudinary' ) ); ?></p>
		</label>
		<?php
	}
